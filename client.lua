...
local carspawns = {
	[1] =  { ['coords'] = vector4(170.43, -1519.26, 29.14, 313.97), ['info'] = ' car 8' },
	[2] =  { ['coords'] = vector4(158.79, -1507.49, 29.14, 315.32), ['info'] = ' car 1' },
	[3] =  { ['coords'] = vector4(146.42, -1515.35, 29.14, 142.18), ['info'] = ' car 2' },
	[4] =  { ['coords'] = vector4(143.71, -1513.48, 29.14, 138.56), ['info'] = ' car 3' },
	[5] =  { ['coords'] = vector4(141.14, -1511.48, 29.14, 145.41), ['info'] = ' car 4' },
	[6] =  { ['coords'] = vector4(73.99, -1552.22, 29.47, 52.47), ['info'] = ' car 5' },
	[7] =  { ['coords'] = vector4(148.47, -1497.54, 29.14, 325.47), ['info'] = ' car 6' },
	[8] =  { ['coords'] = vector4(151.89, -1519.61, 29.14, 155.19), ['info'] = ' car 7' },
}
...
function CreateOxyVehicle()
    ...
    while true do
		Citizen.Wait(1)
		DrawText3Ds(carspawns[spawnpoint]['coords']["x"], carspawns[spawnpoint]['coords']["y"], carspawns[spawnpoint]['coords']["z"], "Your Delivery Car.")
...
RegisterNetEvent('nh-context:testMenu', function(data)
    TriggerEvent('nh-context:sendMenu', {
        ...
        {
            id = 2,
            header = "Start An Oxy Run",
            txt = "Oxy Runs Cost $2,500",
            params = {
                event = "oxydelivery:startDealing",
                args = '1'
            }
        },
        {
